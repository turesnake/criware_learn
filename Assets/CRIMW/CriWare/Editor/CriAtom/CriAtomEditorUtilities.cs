...
public class CriAtomEditorUtilities
{
	 ...
	 * If the current scene in the Editor has a CriWare Initializer component, <br/>
	 * the initialization will use its settings. Otherwise, the default settings will be used.</para>
	 * </remarks>
	 */
