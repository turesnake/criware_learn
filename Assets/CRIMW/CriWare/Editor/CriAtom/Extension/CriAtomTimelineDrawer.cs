...
namespace CriTimeline.Atom {
	...
	public class CriAtomClipWaveformPreviewer {
		...
		private bool LoadWaveform(IntPtr acbHn, string cueName, ref System.Int16[] decodeLpcmBuffer) {
			...
			var result = CRIWAREF8B31BD5(acbHn, cueName, gcHandle.AddrOfPinnedObject(), decodeLpcmBuffer.LongLength);
			gcHandle.Free();
			return result;
		}
		...
		private static extern bool CRIWAREF8B31BD5(IntPtr acbHn, string cue_name, IntPtr decode_lpcm_buffer, System.Int64 decodeLpcmBufferLength);
#else
		private static bool CRIWAREF8B31BD5(IntPtr acbHn, string cue_name, IntPtr decode_lpcm_buffer, System.Int64 decodeLpcmBufferLength) {return false;}
#endif
		#endregion
	}
