...
namespace CriMana.Detail
{
	...
	public class RendererResourceIOSH264Yuv : RendererResource
	{
		...
		{
			bool isFrameUpdated = CRIWARE9CFA0325(playerId, 0, null, frameInfo, ref frameDrop);
		...
		public override void UpdateTextures()
		{
			...
			bool isTextureUpdated = CRIWARE31771903(playerId, numTextures, nativePtrs); // out textures
