 ...
 * By combining with ::CriFsBinder , the content in the CPK file can also be read.<br/></para>
 * </remarks>
...
public class CriFsLoader : CriDisposable
{
	 ...
	 * To get the load completion status, use the ::CriFsLoader::GetStatus function.<br/></para>
	 * </remarks>
	 * <seealso cref='CriFsLoader::GetStatus'/>
	 */
	 ...
	 * <para header='Description'>Starts reading data with the specified binder and file name.<br/>
	 * Read loadSize bytes from offset fileOffset in the file.<br/>
	 * Unlike the ::CriFsLoader::Load function, even if the data is compressed, it will load the data in memory without expanding it.<br/>
	 * This function returns immediately.<br/>
	 * To get the load completion status, use the ::CriFsLoader::GetStatus function.<br/></para>
	 * </remarks>
	 * <seealso cref='CriFsLoader::GetStatus'/>
	 ...
	 * <br/>
	 * This function returns immediately.<br/>
	 * To get the stopping status, use the ::CriFsLoader::GetStatus function.<br/></para>
	 * <para header='Note'>Even if this function is called, data transfer to the buffer may continue
	 * until the loader status ::CriFsLoader::Status changes to Stop.<br/></para>
	 * </remarks>
	 * <seealso cref='CriFsLoader::GetStatus'/>
	 */
	public void Stop()
 ...
 * -# Get the installation progress using the ::CriFsInstaller::GetProgress function.
 * -# After a certain period of time, get the installation progress again.
 * -# If the values obtained in step 1. and step 2. are the same, stop the installation using the ::CriFsInstaller::Stop function.</para>
 * </remarks>
 */
public class CriFsInstaller : CriDisposable
{
	 ...
	 * <br/>
	 * This function returns immediately.<br/>
	 * To get the copy completion status, use the ::CriFsInstaller::GetStatus function.</para>
	 * </remarks>
	 * <seealso cref='CriFsInstaller::GetStatus'/>
	 */
	 ...
	 * <br/>
	 * This function returns immediately.<br/>
	 * Use the ::CriFsInstaller::GetStatus function to get the stop completion status.</para>
	 * </remarks>
	 * <seealso cref='CriFsInstaller::GetStatus'/>
	 */
	public void Stop()
	 ...
	 * Progress is a 32 bit floating point number in the range of 0.0 to 1.0.<br/></para>
	 * </remarks>
	 */
...
public class CriFsBinder : CriDisposable
{
	 ...
	 * <remarks>
	 * <para header='Description'>Output information of the ::CriFsBinder::GetContentsFileInfo function.<br/>
	 * Stores the information for accessing the content file of the searched CPK file.<br/></para>
	 * </remarks>
	 ...
	 * Complete.<br/>
	 * You can get the binding status using the ::CriFsBinder::GetStatus function.<br/></para>
	 * </remarks>
	 * <seealso cref='CriFsBinder::GetStatus'/>
	 ...
	 * - Functions ::CriFsLoader::Load or ::CriFsBinder::GetFileSize may block for a long time.<br/>
	 ...
	 * (Convert the data in the directory to a CPK file and bind it using the ::CriFsBinder::BindCpk function,
	 * or bind all the files in the directory using the ::CriFsBinder::BindFile function.)<br/></para>
	 * </remarks>
	 * <seealso cref='CriFsBinder::GetStatus'/>
	 * <seealso cref='CriFsBinder::Unbind'/>
	 ...
	 * <para header='Note'>When a directory is bound using the ::CriFsBinder::BindDirectory function,
	 * the process may be blocked in this function for a long time.</para>
	 * </remarks>
	 ...
	 * The maximum value that can be specified for index and numFiles is the total number of files that can be acquired using ::CriFsBinder::GetNumContentsFiles .</para>
	 * </remarks>
	 * <seealso cref='CriFsBinder::GetContentsFileInfo(string, out ContentsFileInfo)'/>
	 ...
	 * that can be specified in the ::CriFsBinder::GetContentsFileInfoByIndex function for the same bind ID.</para>
	 * </remarks>
	 * <seealso cref='CriFsBinder::GetContentsFileInfoByIndex'/>
	 */
	public static int GetNumContentsFiles(uint bindId)
	{
		return CRIWARE9B0ABDF0(bindId);
	}
	...
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern int CRIWARE9B0ABDF0(uint id);
	...
	private static int CRIWARE9B0ABDF0(uint id) { return 0; }
	#endif
 ...
 * <remarks>
 * <para header='Description'>A module for checking the progress or getting the result of the asynchronous process.<br/>
 * The value of isDone becomes True when the asynchronous process completes.<br/>
 * If an error occurs during the asynchronous process, the error information is stored in error.<br/></para>
 * </remarks>
 */
public class CriFsRequest : CriDisposable
{
	 ...
	 * <remarks>
	 * <para header='Description'>A parameter to check the completion of asynchronous process.<br/>
	 * The value of isDone is False during asynchronous process.<br/>
	 * The value of isDone becomes True when the asynchronous process completes.<br/></para>
	 * </remarks>
	 */
 ...
 * It is returned as the return value of the ::CriFsUtility::LoadFile function.<br/>
 * <br/>
...
public class CriFsLoadFileRequest : CriFsRequest
{
	 ...
	 * The path specified when calling the ::CriFsUtility::LoadFile function is stored.<br/></para>
	 * </remarks>
	 * <seealso cref='CriFsUtility::LoadFile'/>
	 */
	 ...
	 * If the loading process is stopped using the ::CriFsLoadFileRequest::Stop function
 ...
 * It is returned as the return value of the ::CriFsUtility::LoadAssetBundle function.<br/>
 * <br/>
...
public class CriFsLoadAssetBundleRequest : CriFsRequest
{
	 ...
	 * The path specified when calling the ::CriFsUtility::LoadAssetBundle function is stored.<br/></para>
	 * </remarks>
	 * <seealso cref='CriFsUtility::LoadAssetBundle'/>
	 */
	public string path { get; private set; }
 ...
 * It is returned as the return value of the ::CriFsUtility::Install function.<br/>
 * <br/>
 ...
 * This function retries infinitely unless you explicitly call ::CriFsInstallRequest::Stop .<br/>
 * When performing timeout handling, monitor the value of ::CriFsInstallRequest::progress , and if the value does not change
 * even after sufficient time, stop the installation process using ::CriFsInstallRequest::Stop etc.<br/></para>
 * </remarks>
...
public class CriFsInstallRequest : CriFsRequest
{
	 ...
	 * The path specified when calling the ::CriFsUtility::Install function is stored.<br/></para>
	 * </remarks>
	 * <seealso cref='CriFsUtility::LoadAssetBundle'/>
	 */
	 ...
	 * <br/>
	 * When the process is stopped using the ::CriFsInstallRequest::Stop function, the progress at the time of the stop is saved.<br/>
...
public class CriFsInstallRequestLegacy : CriFsInstallRequest
{
	 ...
	 * When the installation process stops, the ::CriFsInstallRequest::WaitForDone function running as a coroutine returns.<br/></para>
	 * </remarks>
	 */
	public override void Stop()
	{
 ...
 * <remarks>
 * <para header='Description'>A module for checking the progress or getting the result of the installation process.<br/>
 * It is returned as the return value of the ::CriFsUtility::WebInstall function.<br/>
 * <br/>
 * The value of isDone becomes True when the installation process completes.<br/>
...
public class CriFsWebInstallRequest : CriFsInstallRequest
{
	 ...
	 * This function returns immediately.<br/>
	 * It may take up to 20 seconds until the installation process stops after calling this function.<br/>
	 * When the installation process stops, the ::CriFsWebInstallRequest::WaitForDone
 ...
 * <remarks>
 * <para header='Description'>A module for checking the progress or getting the result of the binding process.<br/>
 * It is returned as the return value of the CriFsUtility::BindCpk function.<br/>
 * <br/>
 * The value of isDone becomes True when the binding process completes.<br/>
 * If an error occurs during the binding process, the error information is stored in error.<br/></para>
 * </remarks>
...
public class CriFsBindRequest : CriFsRequest
{
	 ...
	 * The path specified when calling the ::CriFsUtility::BindCpk function etc. is stored.<br/></para>
	 * </remarks>
...
public static class CriFsUtility
{
	 ...
	 * <br/>
	 * This function returns immediately.<br/>
	 * You should check ::CriFsLoadFileRequest::isDone to check the completion of the loading.<br/>
	 * If an error occurs during the loading process, the error information is stored in ::CriFsLoadFileRequest::error .<br/></para>
	 * <para header='Note'>When loading the data in the CPK file,
	 * it is necessary to use ::CriFsUtility::LoadFile instead of this function
	 ...
	 * </para>
	 * </remarks>
	 * <example>The code to load a file using the ::CriFsUtility::LoadFile function is as follows.<br/><code>
	 ...
	 * }
	 * </code>
	 * <br/>If you want to read the data under the StreamingAssets folder, prepend CriWare::Common::streamingAssetsPath
	 * to the file path.<code>
	 ...
	 * You should check ::CriFsLoadFileRequest::isDone to check the completion of the loading.<br/>
	 * If an error occurs during the loading process, the error information is stored in ::CriFsLoadFileRequest::error .<br/></para>
	 * <para header='Note'>Same as the ::CriFsUtility::LoadFile function, except that the binder is specified as the first argument.<br/></para>
	 * </remarks>
	 * <seealso cref='CriFsLoadFileRequest'/>
	 ...
	 * <br/>
	 * This function returns immediately.<br/>
	 * You should check ::CriFsLoadAssetBundleRequest::isDone to check the completion of the loading.<br/>
	 * If an error occurs during the loading process, the error information is stored in ::CriFsLoadFileRequest::error .<br/></para>
	 * <para header='Note'>When loading the asset data in the CPK file,
	 * it is necessary to use ::CriFsUtility::LoadAssetBundle instead of this function
	 * to specify the binder from which to load the data.<br/>
	 * <br/>
	 * You can also load the file from network by specifying a URL in the path.<br/><code>
	 ...
	 * </para>
	 * </remarks>
	 * <example>The code to load an Asset Bundle using the ::CriFsUtility::LoadAssetBundle function is as follows.<br/><code>
	 ...
	 * You should check ::CriFsLoadAssetBundleRequest::isDone to check the completion of the loading.<br/>
	 * If an error occurs during the loading process, the error information is stored in ::CriFsLoadFileRequest::error .<br/></para>
	 * <para header='Note'>Same as the ::CriFsUtility::LoadAssetBundle function, except that the binder is specified as the first argument.<br/></para>
	 * </remarks>
	 * <seealso cref='CriFsLoadAssetBundleRequest'/>
	 ...
	 * <br/>
	 * This function returns immediately.<br/>
	 * You should use ::CriFsInstallRequest::isDone to check the completion of the installation.<br/>
	 * If an error occurs during the installation process, the error information is stored in ::CriFsInstallRequest::error .<br/>
	 * <br/>
	 ...
	 * </remarks>
	 * <example>The code to install the file using the ::CriFsUtility::Install function is as follows.<br/><code>
	 ...
	 * <br/>
	 * This function returns immediately.<br/>
	 * You should check ::CriFsInstallRequest::isDone to check the completion of the installation.<br/>
	 * If an error occurs during the installation process, the error information is stored in ::CriFsInstallRequest::error .<br/></para>
	 * <para header='Note'>Same as the ::CriFsUtility::Install(string, string) function, except that the binder is specified as the first argument.<br/>
	 ...
	 * <br/>
	 * This function returns immediately.<br/>
	 * You should check ::CriFsWebInstallRequest::isDone to check the completion of the installation.<br/>
	 * If an error occurs during the installation process, the error information is stored in ::CriFsWebInstallRequest::error .<br/></para>
	 ...
	 * <br/>
	 * This function returns immediately.<br/>
	 * You should check ::CriFsBindRequest::isDone to check the completion of the binding.<br/>
	 * If an error occurs during the binding process, the error information is stored in ::CriFsBindRequest::error .<br/>
	 * <br/>
	 ...
	 * you must call ::CriFsUtility::BindCpk(CriFsBinder, CriFsBinder, string)
	 ...
	 * </remarks>
	 * <example>The code to load the contents in the CPK file using the
	 * ::CriFsUtility::BindCpk and ::CriFsUtility::LoadFile functions is as follows.<br/><code>
	 ...
	 * <remarks>
	 * <para header='Description'>Start binding the CPK file.<br/>
	 * In addition to ::CriFsUtility::BindCpk(CriFsBinder, string),
	 * you can specify the binder to access to the sub CPK in the CPK file.<br/>
	 * <br/>
	 * This function returns immediately.<br/>
	 * You should check ::CriFsBindRequest::isDone to check the completion of the binding.<br/>
	 * If an error occurs during the binding process, the error information is stored in ::CriFsBindRequest::error .<br/></para>
	 * </remarks>
	 * <seealso cref='CriFsBindRequest'/>
	 ...
	 * - When accessing files in the bound directory, stream playback of sound or movie is interrupted.<br/></para>
	 * <para header='Note'>Be careful not to use this function in the application when final release.<br/>
	 * (Convert the data in the directory to a CPK file and bind it using the ::CriFsUtility::BindCpk function,
	 * or bind all the files in the directory using the ::CriFsUtility::BindFile function.)<br/></para>
	 * </remarks>
	 * <seealso cref='CriFsBindRequest'/>
	 * <seealso cref='CriFsUtility::BindCpk'/>
	 * <seealso cref='CriFsUtility::BindFile'/>
	 ...
	 * In addition to ::CriFsUtility::BindDirectory(CriFsBinder, string),
	 ...
	 * ::CriFsBinder::GetFileSize function after binding the file.<br/></para>
	 * </remarks>
	 * <example>The code to get the file size using the
	 * ::CriFsUtility::BindFile and ::CriFsBinder::GetFileSize functions is as follows.<br/><code>
	 ...
	 * In addition to ::CriFsUtility::BindFile(CriFsBinder, string),
	...
	{
		/* User-Agent文字列を指定 */
		CRIWARE99094ED5(userAgentString);
	}
	...
	{
		/* プロキシ設定 */
		CRIWARE01339870(proxyPath, proxyPort);
	}
	...
	{
		CRIWARE4EBE5FF8(filter);
	}

	#region DLL Import
	#if !CRIWARE_ENABLE_HEADLESS_MODE
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern bool CRIWARE99094ED5(string userAgentString);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern bool CRIWARE01339870(string proxyPath, UInt16 proxyPort);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern bool CRIWARE4EBE5FF8(string filter);
	#else
	private static bool CRIWARE99094ED5(string userAgentString) { return true; }
	private static bool CRIWARE01339870(string proxyPath, UInt16 proxyPort) { return true; }
	private static bool CRIWARE4EBE5FF8(string filter) {return true; }
	#endif
	#endregion
}
...
public static class CriFsPlugin
{
	...
	public static void InitializeLibrary()
	{
		...
		/* ライブラリの初期化 */
		CriFsPlugin.CRIWARE450A4C38();
	}

	public static bool IsLibraryInitialized()
	{
		/* ライブラリが初期化済みかチェック */
		return CRIWARE735D7FE3();
	}
	...
	public static void FinalizeLibrary()
	{
		...
		/* ライブラリの終了 */
		CriFsPlugin.CRIWARE352F5DAB();
	}

	#region DLL Import
	#if !CRIWARE_ENABLE_HEADLESS_MODE
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE1B341AA3(
	...
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE450A4C38();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern bool CRIWARE735D7FE3();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE352F5DAB();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern uint CRIWARE8E75B8AF();
	...
	private static void CRIWARE1B341AA3(
		int num_loaders, int num_binders, int num_installers, int max_path, bool minimize_file_descriptor_usage, bool enable_crc_check) { }
	private static void CRIWARE450A4C38() { _dummyInitialized = true; }
	public static bool CRIWARE735D7FE3() { return _dummyInitialized; }
	private static void CRIWARE352F5DAB() { _dummyInitialized = false; }
	public static uint CRIWARE8E75B8AF() { return 0u; }
