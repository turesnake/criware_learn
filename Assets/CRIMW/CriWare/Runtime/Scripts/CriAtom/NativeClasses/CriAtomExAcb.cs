...
public class CriAtomExAcb : CriDisposable
{
	 ...
	 * Loading the ACB file returns an CriAtomExAcb object ( ::CriAtomExAcb )
	 ...
	 * using the ::CriAtomExPlayer::SetCue function for the AtomExPlayer.<br/>
	 ...
	 * <br/>
	 * Loading the ACB data returns an CriAtomExAcb object ( ::CriAtomExAcb )
	 * for accessing the ACB data.<br/>
	 * You can play the Cue in the ACB file by specifying the ACB handle
	 * and the Cue name to be played using the
	 * ::CriAtomExPlayer::SetCue function for the AtomExPlayer.<br/>
	 * <br/>
	 * This function will return null as a return value
	 * if the ACB file cannot be loaded due to a read error.<br/></para>
	 * <para header='Note'>The library must be initialized before calling this function.<br/>
	 ...
	 * Calling the ::CriAtomExAcb::Dispose at the timing when this function returns false
	 ...
	 * in the ::CriAtomExAcb::Dispose function because it waits for the completion of file read.)<br/></para>
	 * </remarks>
	 */
...
public class CriAtomExAcbLoader : CriDisposable
{
	 ...
	 * You should call ::CriAtomExAcbLoader::GetStatus for the return value to check the loading status.
	 * If the status changes to Complete, you can get the ::CriAtomExAcb object using ::CriAtomExAcbLoader::MoveAcb .<br/></para>
	 * </remarks>
	 */
	 ...
	 * You should call ::CriAtomExAcbLoader::GetStatus for the return value to check the loading status.
	 * If the status changes to Complete, you can get ::CriAtomExAcb using ::CriAtomExAcbLoader::MoveAcb .<br/></para>
	 * </remarks>
	 */
	 ...
	 * When the return value of this function changes to Complete, you can get ::CriAtomExAcb using ::CriAtomExAcbLoader::MoveAcb .<br/></para>
	 * </remarks>
	 */
	 ...
	 * Call this function after the return value of ::CriAtomExAcbLoader::GetStatus changes to Complete.<br/></para>
	 * </remarks>
	 */
