...
public class CriAtomEx3dListener : CriDisposable
{
	 ...
	 * <para header='Note'>To actually apply the cleared parameters, you need to call the ::CriAtomEx3dListener::Update function.</para>
	 * </remarks>
	 */
	 ...
	 * <para header='Note'>To actually apply the set parameters, you need to call the ::CriAtomEx3dListener::Update function.</para>
	 * </remarks>
	 ...
	 * To actually apply the set parameters, you need to call the ::CriAtomEx3dListener::Update function.</para>
	 * </remarks>
