...
public class CriAtomExAuxIn : CriDisposable
{
	 ...
	 * <br/>
	 * To start playing a sound, call the ::CriAtomExAuxIn::Start function.<br/>
	 * You pass the sound to be captured to AuxIn through the callback function
	 * specified to ::CriAtomExAuxIn::SetInputReadStream .<br/></para>
	 ...
	 * It must be set before calling ::CriAtomExAuxIn::Start .<br/></para>
	 * </remarks>
	 ...
	 * <param name='samplingRate'>Sampling frequency</param>
	 * <remarks>
	 * <para header='Description'>Gets the format information set using ::CriAtomExAuxIn::SetFormat .<br/></para>
	 * </remarks>
	 ...
	 * (You must set maxSamplingRate in ::CriAtomExAuxIn::Config structure
	 ...
	 * The range and handling of the send level values are the same as for volume. Refer to the ::CriAtomExAuxIn::SetVolume function.</para>
	 * </remarks>
	 */
