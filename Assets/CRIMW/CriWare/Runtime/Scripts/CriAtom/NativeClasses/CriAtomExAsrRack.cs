...
public partial class CriAtomExAsrRack : CriDisposable
{
	 ...
	 * Used in the ::CriAtomExAsrRack::GetPerformanceInfo and ::CriAtomExAsrRack::GetPerformanceInfoByRackId methods.<br/></para>
	 * </remarks>
	...
	public CriAtomExAsrRack(Config config, PlatformConfig platformConfig)
	{
		...
		this._rackId = CRIWAREE91D2087(ref config, ref platformConfig);
	...
	private static extern int CRIWAREE91D2087([In] ref Config config, [In] ref PlatformConfig platformConfig);
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	...
	#else
	private static int CRIWAREE91D2087([In] ref Config config, [In] ref PlatformConfig platformConfig) { return 0; }
