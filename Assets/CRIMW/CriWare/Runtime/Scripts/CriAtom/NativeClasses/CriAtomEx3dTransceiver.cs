...
public class CriAtomEx3dTransceiver : CriDisposable
{
	 ...
	 * <para header='Note'>To actually apply the set parameters, you need to call the ::CriAtomEx3dTransceiver::Update function.</para>
	 * </remarks>
	 ...
	 * you need to call the ::CriAtomEx3dTransceiver::Update function.<br/>
	 ...
	 * <para header='Note'>To actually apply the set parameters, you need to call the ::CriAtomEx3dTransceiver::Update function.<br/></para>
	 * </remarks>
	 * <seealso cref='CriAtomEx3dTransceiver::Update'/>
	 */
