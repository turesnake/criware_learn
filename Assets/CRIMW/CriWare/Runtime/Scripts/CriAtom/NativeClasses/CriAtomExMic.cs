 ...
 * You can also get the information about the sound input device using ::CriAtomExMic::GetDevices .<br/></para>
 * </remarks>
 */
public class CriAtomExMic : CriDisposable
{
	 ...
	 * The device information is acquired from ::CriAtomExMic::GetDevices .<br/></para>
	 * </remarks>
	 */
	 ...
	 * It is specified as an argument of the ::CriAtomExMic::Create function.<br/></para>
	 * </remarks>
	...
	public struct Config
	{
		 ...
		 * This is the processing unit of the effect for which ::CriAtomExMic::AttachEffect was called.<br/></para>
		 * </remarks>
		 */
	 ...
	 * Returned by ::CriAtomExMic::AttachEffect .<br/></para>
	 * </remarks>
	 ...
	 * (You can use the features of the module after calling this function and before calling the ::CriAtomExMic::FinalizeModule function.)<br/></para>
	 * <para header='Note'>After calling this function, be sure to call the corresponding ::CriAtomExMic::FinalizeModule function.<br/>
	 * In addition, this function cannot be called again until the ::CriAtomExMic::FinalizeModule function is called.<br/></para>
	 * </remarks>
	 ...
	 * <br/>
	 * Calling the ::CriAtomExMic::Create function creates an AtomEx microphone
	 ...
	 * <br/>
	 * To actually start sound input, call the ::CriAtomExMic::Start function.<br/>
	 * Use the ::CriAtomExMic::ReadData function for getting the captured sound data.<br/></para>
	 * </remarks>
	 ...
	 * <para header='Note'>This function is valid only when you call ::CriAtomExMic::Start by setting the number of
	 * channels to 1.<br/>
	 ...
	 * number of CriAtomExMic::Config channels passed to ::CriAtomExMic::Start .<br/>
	 * Otherwise, the assertion fails.<br/>
