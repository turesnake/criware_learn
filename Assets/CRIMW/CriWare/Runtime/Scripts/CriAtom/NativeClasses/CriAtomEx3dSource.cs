...
public class CriAtomEx3dSource : CriDisposable
{
	 ...
	 * <para header='Note'>You must call the ::CriAtomEx3dSource::Update function to actually apply the parameters you have set.<br/>
	 ...
	 * <para header='Note'>This parameter is referenced only when ::CriAtomEx::Randomize3dCalcType::List <br/>
	 ...
	 * ::CriAtomEx3dSource::SetRandomPositionList function is completed.<br/>
	 * Instead, the list of the coordinates will be saved internally.<br/>
	 * Therefore, setting a list whose length exceeds<br/>
	 * ::CriAtomEx3dSource::Config::randomPositionListMaxLength will result in an error.<br/></para>
	 * </remarks>
	 * <seealso cref='CriAtomEx::Randomize3dConfig'/>
