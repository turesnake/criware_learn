...
public static class CriAtomPlugin
{
	 ...
	 * <para header='Note'>This function is called periodically by the CriAtom component and usually does not need to be called by the user. <br/>
	 * Please use this function only when you need to call it manually (e.g., when the CriAtom component is not used).</para>
	 * </remarks>
	 */
...
#endif
	/* @endcond */
		CRIWAREDA1E6EBE(max_virtual_voices,
		...
		int communication_buffer_size, int playback_position_update_interval)
	{
		...
		CRIWAREFC7D6F2F((uint)max_preview_objects,
	...
	{
		CRIWARE4CC3319C(enable_sonicsync, buffering_time_ios, override_ipod_music_ios);
	}
	...
	{
		CRIWARED2996351(enable_sonicsync,
		...
		if (use_fast_mixer == true) {
			...
			using (AndroidJavaObject activity = jc.GetStatic<AndroidJavaObject>("currentActivity")) {
				...
				CRIWAREF2561FD7(android_context);
			}
		}
		CRIWARE21270F5B(use_aaudio);
#endif
	}
	...
	public static void SetConfigAdditionalParameters_VITA(int num_atrac9_memory_voices, int num_atrac9_streaming_voices, int num_mana_decoders)
	{
		...
		CRIWARE743D9532(num_atrac9_memory_voices, num_atrac9_streaming_voices, num_mana_decoders);
		#endif
	}
														 ...
														 bool use_audio3d, int num_audio3d_memory_voices, int num_audio3d_streaming_voices)
	{
		...
		CRIWARE6DA7F30F(num_atrac9_memory_voices, num_atrac9_streaming_voices,
	...
	public static void SetConfigAdditionalParameters_SWITCH(int num_opus_memory_voices, int num_opus_streaming_voices, bool init_socket) {
		...
		CRIWARE2F4DF1CB(num_opus_memory_voices, num_opus_streaming_voices, init_socket);
		#endif
	}
	...
	{
		#if UNITY_WEBGL
		CRIWARE36097EAE(num_webaudio_voices);
		#endif
	}
	/* @endcond */
	...
	{
		CRIWARED3B4D452(sampling_rate_for_memory, sampling_rate_for_streaming);
	}
	...
	{
		ushort ret = CRIWAREEACE35DB(CRIATOMUNITY_PARAMETER_ID_LOOP_COUNT);
	...
	public static void DecryptAcb(IntPtr acb_hn, ulong key, ulong nonce)
	{
		...
		CRIWARE25DDC3BC(acb_hn, CallbackFromNative, IntPtr.Zero);
		temporalStorage = 0;
	}
	/* @endcond */
	...
	private static extern void CRIWAREDA1E6EBE(int max_virtual_voices,
		int max_voice_limit_groups, int max_categories,
		int max_sequence_events_per_frame, int max_beatsync_callbacks_per_frame,
		int max_cuelink_callbacks_per_frame,
		int num_standard_memory_voices, int num_standard_streaming_voices,
	...
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWAREFC7D6F2F(uint max_preivew_objects,
		uint communication_buffer_size, int playback_position_update_interval);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE0BA5695C(long buffering_time_pc);

	/* @cond excludele */
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWAREDC41FC6A(int output, int pulse_latency_usec);
	/* @endcond */

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE4CC3319C(bool enable_sonicsync, uint buffering_time_ios, bool override_ipod_music_ios);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARED2996351(bool enable_sonicsync, 
																				  int num_low_delay_memory_voices, int num_low_delay_streaming_voices,
																				  int sound_buffering_time,        int sound_start_buffering_time,
	...
	#if !UNITY_EDITOR && UNITY_ANDROID
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWAREF2561FD7(IntPtr android_context);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE21270F5B(bool flag);
	#endif

	/* @cond excludele */
	#if !UNITY_EDITOR && UNITY_PSP2
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE743D9532(int num_atrac9_memory_voices, int num_atrac9_streaming_voices, int num_mana_decoders);
	#endif

	#if !UNITY_EDITOR && (UNITY_PS4 || UNITY_PS5)
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE6DA7F30F(int num_atrac9_memory_voices, int num_atrac9_streaming_voices,
																			  bool use_audio3d, int num_audio3d_memory_voices, int num_audio3d_streaming_voices);
	#endif

	#if !UNITY_EDITOR && UNITY_SWITCH
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE2F4DF1CB(int num_opus_memory_voices, int num_opus_streaming_voices, bool init_socket);
	#endif

	#if UNITY_WEBGL
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE36097EAE(int num_webaudio_voices);
	#endif
	/* @endcond */

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE700ACC65();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern bool CRIWARE59483744();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE4E5B2F55();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE3B387488(bool pause);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern uint CRIWARE1D77FE6E();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern void CRIWARE922BBEF2(int code);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern void CRIWAREFE322E32(IntPtr cbfunc, string separator_string);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern void CRIWARE1BD390A2(IntPtr cbfunc);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE8CE897BE();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern void CRIWAREFC68481C(IntPtr cbfunc);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWAREBCEB3DF3();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern void CRIWAREC16AD8CE(IntPtr cbfunc);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE40A4A692();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARED3B4D452(int sampling_rate_for_memory, int sampling_rate_for_streaming);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern void CRIWARE6A4F040B();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern void CRIWAREC86903A2();

	/* @cond notpublic */
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern void CRIWARE25DDC3BC(IntPtr acb_hn, CallbackFromNativeDelegate func, IntPtr obj);
	/* @endcond */

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern ushort CRIWAREEACE35DB(int id);
	...
	#endif
	#else
	private static void CRIWAREDA1E6EBE(int max_virtual_voices,
		int max_voice_limit_groups, int max_categories,
		int max_sequence_events_per_frame, int max_beatsync_callbacks_per_frame,
		int max_cuelink_callbacks_per_frame,
		int num_standard_memory_voices, int num_standard_streaming_voices,
		...
		int num_buses, bool use_ambisonics,
		IntPtr spatializer_core_interface) { }
	private static void CRIWAREFC7D6F2F(uint max_preivew_objects,
		uint communication_buffer_size, int playback_position_update_interval) { }
	private static void CRIWARE0BA5695C(long buffering_time_pc) { }
	/* @cond excludele */
	private static void CRIWAREDC41FC6A(int output, int pulse_latency_usec) { }
	/* @endcond */
	private static void CRIWARE4CC3319C(bool enable_sonicsync, uint buffering_time_ios, bool override_ipod_music_ios) { }
	private static void CRIWARED2996351(bool enable_sonicsync, 
																		   int num_low_delay_memory_voices, int num_low_delay_streaming_voices,
																		   int sound_buffering_time,          int sound_start_buffering_time,
																		   bool apply_hw_property) { }
	#if !UNITY_EDITOR && UNITY_ANDROID
	private static void CRIWAREF2561FD7(IntPtr android_context) { }
	private static void CRIWARE21270F5B(bool flag) { }
	#endif

	/* @cond excludele */
	#if !UNITY_EDITOR && UNITY_PSP2
	private static void CRIWARE743D9532(int num_atrac9_memory_voices, int num_atrac9_streaming_voices,
																		int num_mana_decoders) { }
	#endif
	#if !UNITY_EDITOR && UNITY_PS4
	private static void CRIWARE6DA7F30F(int num_atrac9_memory_voices, int num_atrac9_streaming_voices,
																		bool use_audio3d, int num_audio3d_memory_voices, int num_audio3d_streaming_voices) { }
	#endif
	#if !UNITY_EDITOR && UNITY_SWITCH
	private static void CRIWARE2F4DF1CB(int num_opus_memory_voices, int num_opus_streaming_voices, bool init_socket) { }
	#endif
	#if UNITY_WEBGL
	private static void CRIWARE36097EAE(int num_webaudio_voices) { }
	#endif
	/* @endcond */
	private static bool _dummyInitialized = false;
	private static void CRIWARE700ACC65() { _dummyInitialized = true; }
	public static bool CRIWARE59483744() { return _dummyInitialized; }
	private static void CRIWARE4E5B2F55() { _dummyInitialized = false; }
	private static void CRIWARE3B387488(bool pause) { }
	public static uint CRIWARE1D77FE6E() { return 0; }
	public static void CRIWARE922BBEF2(int code) { }
	public static void CRIWAREFE322E32(IntPtr cbfunc, string separator_string) { }
	public static void CRIWARE1BD390A2(IntPtr cbfunc) { }
	public static void CRIWARE8CE897BE() { }
	public static void CRIWAREFC68481C(IntPtr cbfunc) { }
	public static void CRIWAREBCEB3DF3() { }
	public static void CRIWAREC16AD8CE(IntPtr cbfunc) { }
	public static void CRIWARE40A4A692() { }
	private static void CRIWARED3B4D452(int sampling_rate_for_memory, int sampling_rate_for_streaming) { }
	public static void CRIWARE6A4F040B() { }
	public static void CRIWAREC86903A2() { }
	/* @cond notpublic */
	public static void CRIWARE25DDC3BC(IntPtr acb_hn, CallbackFromNativeDelegate func, IntPtr obj) { }
	/* @endcond */
	public static ushort CRIWAREEACE35DB(int id) { return 0; }
#if !UNITY_EDITOR && UNITY_IOS
 ...
 * it will automatically be created as an object with the name "CRIWARE". Normally, you do not need to create it.
	...
	*/
	...
	void OnDestroy()
	{
		...
		if (beatsyncUserCbFunc != null) {
			...
			CriAtomPlugin.CRIWAREFC68481C(IntPtr.Zero);
		}
	...
	public static void SetEventCallback(CriAtomExSequencer.EventCbFunc func, string separator)
	{
		...
		CriAtomPlugin.CRIWAREFE322E32(ptr, separator);
	}
	...
	private static void RegisterEventCallbackChain(CriAtomExSequencer.EventCallback func)
	{
		...
		if (eventUserCallback == null) {
			...
			ptr = Marshal.GetFunctionPointerForDelegate(delegateObject);
			CriAtomPlugin.CRIWARE1BD390A2(ptr);
		}
	...
	private static void UnregisterEventCallbackChain(CriAtomExSequencer.EventCallback func)
	{
		eventUserCallback -= func;
		if (eventUserCallback == null) {
			CriAtomPlugin.CRIWARE1BD390A2(IntPtr.Zero);
		}
	}
	...
	private static void RegisterBeatSyncCallbackChain(CriAtomExBeatSync.CbFunc func)
	{
		if (beatsyncUserCbFunc == null) {
			...
			CriAtomPlugin.CRIWAREFC68481C(ptr);
		}
	...
	private static void RegisterCueLinkCallbackChain(CriAtomEx.CueLinkCbFunc func)
	{
		if (cueLinkUserCbFunc == null) {
			...
			var ptr = Marshal.GetFunctionPointerForDelegate(delegateObject);
			CriAtomPlugin.CRIWAREC16AD8CE(ptr);
		}
	...
	private static void UnregisterCueLinkCallbackChain(CriAtomEx.CueLinkCbFunc func)
	{
		cueLinkUserCbFunc -= func;
		if (cueLinkUserCbFunc == null) {
			CriAtomPlugin.CRIWAREC16AD8CE(IntPtr.Zero);
		}
	}
