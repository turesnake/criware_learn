...
{
	/* スクリプトバージョン */
	private const string scriptVersionString = "2.38.29";
	...
	{
		return CriFsPlugin.CRIWARE8E75B8AF();
	}
	...
	{
		return CriAtomPlugin.CRIWARE1D77FE6E();
	}
	...
	public static uint GetManaMemoryUsage()
	{
        ...
        return 0;
#else
		return CriManaPlugin.CRIWAREE9D3B2B3();
#endif
	}
	...
	public static extern int CRIWARE39DE2C86();

	[DllImport(pluginName, CallingConvention = pluginCallingConvention)]
	public static extern void criWareUnity_SetRenderingEventOffsetForMana(int offset);
	#else
	public static int CRIWARE39DE2C86() { return GetRequiredBinaryVersionNumber(); }
