...
namespace CriMana.Detail
{
	...
	#error unsupported platform
		...
		{
			// Note: This renderer use a deprecated API: CRIWARECB2B77E5.
			// Todo: use CRIWARE31771903 with a c++ rendereDecoder class if needed.
			bool isFrameUpdated = CRIWARECB2B77E5(
				playerId,
		...
		private static extern bool CRIWARECB2B77E5(
			int player_id,
