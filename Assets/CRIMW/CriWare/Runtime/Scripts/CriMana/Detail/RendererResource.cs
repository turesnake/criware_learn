...
namespace CriMana.Detail
{
	public abstract class RendererResource : System.IDisposable
	{
		...
		{
			return CRIWAREF6990771(playerId);
		}
		...
		protected static extern bool CRIWARE9CFA0325(
			int player_id,
			int num_textures,
		...
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		protected static extern bool CRIWARE31771903(
			int player_id,
			int num_textures,
        ...
        [DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
        protected static extern bool CRIWAREE48A175F(
            int player_id,
            int num_textures,
            [In, Out] System.IntPtr[] tex_ptrs
        );
        ...
        [DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
        protected static extern bool CRIWAREBA36D839(
            int player_id,
            int num_textures,
            [In, Out] System.IntPtr[] tex_ptrs
        );
        ...
        [DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
        protected static extern sbyte CRIWAREF6990771(
            int player_id
        );
		#else
		protected static bool CRIWARE9CFA0325(
			int player_id,
			int num_textures,
			System.IntPtr[] tex_ptrs,
			[In, Out] FrameInfo frame_info,
		...
		protected static bool CRIWARE31771903(
			int player_id,
			int num_textures,
			[In, Out] System.IntPtr[] tex_ptrs
		) { return true; }

		protected static bool CRIWAREE48A175F(
			int player_id,
			int num_textures,
			[In, Out] System.IntPtr[] tex_ptrs
		) { return true; }

		protected static bool CRIWAREBA36D839(
			int player_id,
			int num_textures,
			[In, Out] System.IntPtr[] tex_ptrs
		) { return true; }

        protected static sbyte CRIWAREF6990771(
            int player_id
        ) { return 0; }
		#endif
		#endregion
