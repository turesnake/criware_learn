 ...
 */
	public class Player : CriDisposable
	{
		...
		{
			get {
				return CRIWAREAE09109C(playerId);
			}
		}
		...
		public Player(bool advanced_audio_mode, bool ambisonics_mode, uint max_path_length) {
			...
			if (advanced_audio_mode || max_path_length > 0) {
				playerId = CRIWAREC4D90369(advanced_audio_mode, max_path_length);
				if (advanced_audio_mode) {
					/* AtomExPlayer 作成 */
					_atomExPlayer = new CriAtomExPlayer(CRIWAREE519D48A(playerId));
					if (ambisonics_mode) {
		...
		{
			CRIWAREAB449BA3(playerId, (sw) ? 1 : 0);
		...
		{
			return CRIWARE022716DB(playerId);
		}
		...
		public bool SetFile(CriFsBinder binder, string moviePath, SetMode setMode = SetMode.New)
		{
			...
			if (setMode == SetMode.New) {
				CRIWAREFE2345B4(playerId, binderPtr, moviePath);
				return true;
			} else {
				return CRIWARE657DB598(
		...
		{
			if (setMode == SetMode.New) {
				CRIWARE81974EFB(playerId, data, dataSize);
				return true;
			} else {
				return CRIWARE2650B0BB(
		...
		*/
		...
		public bool SetContentId(CriFsBinder binder, int contentId, SetMode setMode = SetMode.New)
		{
			...
			if (setMode == SetMode.New) {
				CRIWARE097F2388(playerId, binder.nativeHandle, contentId);
				return true;
			}
			else {
				return CRIWARE95EEB9DC(
		...
		{
			if (setMode == SetMode.New) {
				CRIWARE05B1AB85(playerId, filePath, offset, range);
				return true;
			}
			else {
				return CRIWARE1D8BC567(
		...
		{
			CRIWARE1AA31155(playerId, sw ? 1 : 0);
		}
		...
		public void SetMasterTimerType(TimerType timerType)
		{
			...
			CRIWARE112FF1E0(playerId, timerType);
		}
		...
		{
			CRIWARE28061351(playerId, frameNumber);
		}
		...
		{
			CRIWAREDA49EF32(playerId, speed);
		}
		...
		{
			CRIWARE35E65302(playerId, maxDataSize);
		}
		...
		{
			CRIWARE58C11CCA(playerId, min_buffer_size);
		}
		...
		{
			CRIWAREBAF04F9E(playerId, track);
		}
		...
		public void SetAudioTrack(AudioTrack track)
		{
			if (track == AudioTrack.Off) {
				CRIWAREBAF04F9E(playerId, -1);
			} else if (track == AudioTrack.Auto) {
				CRIWAREBAF04F9E(playerId, 100);
			}
		}
		...
		{
			CRIWARE8509AA3D(playerId, track);
		}
		...
		{
			if (track == AudioTrack.Off) {
				CRIWARE8509AA3D(playerId, -1);
			} else if (track == AudioTrack.Auto) {
				CRIWARE8509AA3D(playerId, 100);
			}
		}
		...
		{
			CRIWAREE3CF16E5(playerId, track);
		}
		...
		{
			if (track == AudioTrack.Off) {
				CRIWAREE3CF16E5(playerId, -1);
			} else if (track == AudioTrack.Auto) {
				CRIWAREE3CF16E5(playerId, 100);
			}
		}
		...
		{
			CRIWARE805B07D5(playerId, volume);
		}
		...
		{
			return CRIWARE82708732(playerId);
		}
		...
		{
			CRIWAREBDBD89BD(playerId, volume);
		}
		...
		{
			return CRIWAREE5805470(playerId);
		}
		...
		{
			CRIWARE2B5F10E3(playerId, volume);
		}
		...
		{
			return CRIWARE7AFE8454(playerId);
		}
		...
		{
			CRIWARE9D3A7CAF(playerId, bus_name, level);
		}
		...
		{
			CRIWARE06D929D3(playerId, bus_name, volume);
		}
		...
		{
			CRIWARED5D2F9E3(playerId, bus_name, volume);
		}
		...
		public void SetSubtitleChannel(int channel)
		{
			...
			CRIWARE5B801B29(playerId, channel);
		}
		...
		public long GetTime()
		{
			return CRIWARECD64589F(this.playerId);
		}
		...
		{
			return CRIWARED691366B(this.playerId);
		}
		...
		{
			CRIWARE86E64D31(this.playerId, asrRackId);
		}
		...
		public void UpdateWithUserTime(ulong timeCount, ulong timeUnit)
		{
			...
			CRIWARE5B9EF4D4(this.playerId, timeCount, timeUnit);
			InternalUpdate();
		}
		...
		public void SetManualTimerUnit(ulong timeUnitN, ulong timeUnitD)
		{
			...
			CRIWAREACBC8641(this.playerId, timeUnitN, timeUnitD);
		}
		...
		private void InternalUpdate()
		{
			...
			{
				CRIWARE0D2A289B(playerId, _movieInfo);
		...
		private void UpdateNativePlayer()
		{
			...
			_nativeStatus = (Status)CRIWAREAE5C94ED(playerId, subtitleBuffer, ref subtitleSizeTmp);
			...
			if (enableSubtitle) {
				var changed = CRIWARE80AAB052(playerId);
				if (changed) {
					if (OnSubtitleChanged != null){
						OnSubtitleChanged(subtitleBuffer);
					}
					CRIWARE3EEC01C6(playerId);
				}
			}
		...
		private static extern int CRIWARE9A656A6F();
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern int CRIWARE23BA822A();
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern int CRIWAREC4D90369(bool useAtomExPlayer, uint maxPathLength);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE755E3F8F(int player_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWAREFE2345B4(int player_id, System.IntPtr binder, string path);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE097F2388(int player_id, System.IntPtr binder, int content_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE05B1AB85(int player_id, string path, System.UInt64 offset, System.Int64 range);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE81974EFB(int player_id, IntPtr data, System.Int64 datasize);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE81974EFB(int player_id, byte[] data, System.Int64 datasize);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern bool CRIWARE657DB598(int player_id, System.IntPtr binder, string path, bool repeat);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern bool CRIWARE95EEB9DC(int player_id, System.IntPtr binder, int content_id, bool repeat);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern bool CRIWARE1D8BC567(int player_id, string path, System.UInt64 offset, System.Int64 range, bool repeat);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern bool CRIWARE2650B0BB(int player_id, IntPtr data, System.Int64 datasize, bool repeat);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern bool CRIWARE2650B0BB(int player_id, byte[] data, System.Int64 datasize, bool repeat);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE4EC97CD8(int player_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern System.Int32 CRIWAREAE09109C(int player_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE98160879(
			int player_id,
			CuePointCallbackFromNativeDelegate cbfunc
			);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE0D2A289B(int player_id, [Out] MovieInfo movie_info);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern int CRIWAREAE5C94ED(
			int player_id,
			System.IntPtr subtitle_buffer,
			ref uint subtitle_size
			);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE4837FC4A(int player_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE4D1D6628(int player_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE6BD84242(int player_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE28061351(int player_id, int seek_frame_no);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWAREB4336B28(int player_id, MovieEventSyncMode mode);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWAREAB449BA3(int player_id, int sw);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern bool CRIWARE022716DB(int player_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE1AA31155(int player_id, int sw);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern long CRIWARECD64589F(int player_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern int CRIWAREFBDC9683(int player_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern IntPtr CRIWAREE519D48A(int player_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern int CRIWARED691366B(int player_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWAREBAF04F9E(int player_id, int track);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE805B07D5(int player_id, float vol);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern float CRIWARE82708732(int player_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE8509AA3D(int player_id, int track);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWAREBDBD89BD(int player_id, float vol);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern float CRIWAREE5805470(int player_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWAREE3CF16E5(int player_id, int track);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE2B5F10E3(int player_id, float vol);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern float CRIWARE7AFE8454(int player_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE9D3A7CAF(int player_id, string bus_name, float level);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE06D929D3(int player_id, string bus_name, float level);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARED5D2F9E3(int player_id, string bus_name, float level);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE5B801B29(int player_id, int channel);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWAREDA49EF32(int player_id, float speed);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE35E65302(int player_id, System.UInt32 max_data_size);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		public static extern void CRIWAREC3141101(int player_id, float sec);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		public static extern void CRIWARE58C11CCA(int player_id, int min_buffer_size);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		public static extern void CRIWARE86E64D31(int player_id, int asr_rack_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE7FAFA7A0(int player_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE112FF1E0(int player_id, TimerType timer_type);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE5B9EF4D4(int player_id, ulong user_count, ulong user_unit);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWAREACBC8641(int player_id, ulong timer_unit_n, ulong timer_unit_d);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE0A3699D8(int player_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE64F8C98F(int player_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern IntPtr CRIWAREC86CA990(int player_id, int bufferSize);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern bool CRIWARE80AAB052(int player_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE3EEC01C6(int player_id);
#if !CRIPLUGIN_USE_OLD_LOWLEVEL_INTERFACE
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		...
		private static int CRIWARE9A656A6F() { return 0; }
		private static int CRIWARE23BA822A() { return 0; }
		private static int CRIWAREC4D90369(bool useAtomExPlayer, uint maxPathLength) { return 0; }
		private static void CRIWARE755E3F8F(int player_id) { }
		private static void CRIWAREFE2345B4(int player_id, System.IntPtr binder, string path) { }
		private static void CRIWARE097F2388(int player_id, System.IntPtr binder, int content_id) { }
		private static void CRIWARE05B1AB85(int player_id, string path, System.UInt64 offset, System.Int64 range) { }
		private static void CRIWARE81974EFB(int player_id, IntPtr data, System.Int64 datasize) { }
		private static void CRIWARE81974EFB(int player_id, byte[] data, System.Int64 datasize) { }
		private static bool CRIWARE657DB598(int player_id, System.IntPtr binder, string path, bool repeat) { return true; }
		private static bool CRIWARE95EEB9DC(int player_id, System.IntPtr binder, int content_id, bool repeat) { return true; }
		private static bool CRIWARE1D8BC567(int player_id, string path, System.UInt64 offset, System.Int64 range, bool repeat) { return true; }
		private static bool CRIWARE2650B0BB(int player_id, IntPtr data, System.Int64 datasize, bool repeat) { return true; }
		private static bool CRIWARE2650B0BB(int player_id, byte[] data, System.Int64 datasize, bool repeat) { return true; }
		private static void CRIWARE4EC97CD8(int player_id) { }
		private static System.Int32 CRIWAREAE09109C(int player_id) { return 0; }
		private static void CRIWARE98160879(int player_id, CuePointCallbackFromNativeDelegate cbfunc) { }
		private static void CRIWARE0D2A289B(int player_id, [Out] MovieInfo movie_info) { movie_info = new MovieInfo(); }
		private static int CRIWAREAE5C94ED(int player_id, System.IntPtr subtitle_buffer, ref uint subtitle_size ) { return 0; }
		private void CRIWARE4837FC4A(int player_id) { _dummyPaused = false; _nativeStatus = Status.WaitPrep; }
		private void CRIWARE4D1D6628(int player_id) { _dummyPaused = false; _nativeStatus = Status.WaitPrep; }
		private void CRIWARE6BD84242(int player_id) { _nativeStatus = Status.Stop;  }
		private static void CRIWARE28061351(int player_id, int seek_frame_no) { }
		private static void CRIWAREB4336B28(int player_id, MovieEventSyncMode mode){}
		private void CRIWAREAB449BA3(int player_id, int sw) { _dummyPaused = (sw == 1); }
		private static bool CRIWARE022716DB(int player_id) { return false; }
		private void CRIWARE1AA31155(int player_id, int sw) { _dummyLoop = (sw == 1); }
		private static long CRIWARECD64589F(int player_id) { return 0; }
		private static int CRIWAREFBDC9683(int player_id) { return 0; }
		private static IntPtr CRIWAREE519D48A(int player_id) { return new IntPtr(1); }
		private static int CRIWARED691366B(int player_id) { return -1; }
		private static void CRIWAREBAF04F9E(int player_id, int track) { }
		private static void CRIWARE805B07D5(int player_id, float vol) { }
		private static float CRIWARE82708732(int player_id){ return 0f; }
		private static void CRIWARE8509AA3D(int player_id, int track) { }
		private static void CRIWAREBDBD89BD(int player_id, float vol) { }
		private static float CRIWAREE5805470(int player_id){ return 0f; }
		private static void CRIWAREE3CF16E5(int player_id, int track) { }
		private static void CRIWARE2B5F10E3(int player_id, float vol) { }
		private static float CRIWARE7AFE8454(int player_id){ return 0f; }
		private static void CRIWARE9D3A7CAF(int player_id, string bus_name, float level) { }
		private static void CRIWARE06D929D3(int player_id, string bus_name, float level) { }
		private static void CRIWARED5D2F9E3(int player_id, string bus_name, float level) { }
		private static void CRIWARE5B801B29(int player_id, int channel) { }
		private static void CRIWAREDA49EF32(int player_id, float speed) { }
		private static void CRIWARE35E65302(int player_id, System.UInt32 max_data_size) { }
		public static void CRIWAREC3141101(int player_id, float sec) { }
		public static void CRIWARE58C11CCA(int player_id, int min_buffer_size) { }
		public static void CRIWARE86E64D31(int player_id, int asr_rack_id) { }
		private static void CRIWARE7FAFA7A0(int player_id) { }
		private static void CRIWARE112FF1E0(int player_id, TimerType timer_type) { }
		private static void CRIWARE5B9EF4D4(int player_id, ulong user_count, ulong user_unit) { }
		private static void CRIWAREACBC8641(int player_id, ulong timer_unit_n, ulong timer_unit_d) { }
		private static void CRIWARE0A3699D8(int player_id) { }
		private static void CRIWARE64F8C98F(int player_id) {}
		private static IntPtr CRIWAREC86CA990(int player_id, int bufferSize){return IntPtr.Zero;}
		private static bool CRIWARE80AAB052(int player_id){return false;}
		private static void CRIWARE3EEC01C6(int player_id){}
		#endif
