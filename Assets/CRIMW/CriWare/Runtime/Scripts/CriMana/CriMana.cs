...
namespace CriMana
{
	...
	public static class Settings
	{
		...
		{
			CriManaPlugin.CRIWAREC0B2FB96(enabled);
		}
...
public class CriManaPlugin
{
	...
	public static void SetConfigParameters(bool graphicsMultiThreaded, int num_decoders, int max_num_of_entries)
	{
		...
		CriManaPlugin.CRIWARE28AEBB45((int)graphicsApi, enabledMultithreadedRendering, num_decoders, max_num_of_entries);
	...
	*/
	...
	public static void SetConfigAdditonalParameters_VITA(bool use_h264_playback, int width, int height)
	{
		...
		CriManaPlugin.CRIWARE5B987B97(use_h264_playback, (UInt32)width, (UInt32)height);
#endif
	}
	*/
	...
	public static void SetConfigAdditonalParameters_PC(bool use_h264_playback)
	{
		...
		CriManaPlugin.CRIWARE1184E87A(use_h264_playback);
#endif
	}
	...
	public static void SetConfigAdditonalParameters_WEBGL(string webworkerPath, uint heapSize)
	{
		...
		CriManaPlugin.CRIWARE8ACDA935(webworkerPath,heapSize);
#endif
	}
	...
	{
		CriManaPlugin.CRIWARE36366D11();
	}

	public static void Unlock()
	{
		CriManaPlugin.CRIWARE50B51DBE();
	}

	#region DLL Import
	#if !CRIWARE_ENABLE_HEADLESS_MODE
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE28AEBB45(int graphics_api, bool graphics_multi_threaded, int num_decoders, int num_of_max_entries);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE7AD1946D();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern bool CRIWARE69680403();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWAREB4FA43FA();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern void CRIWAREC0B2FB96(bool flag);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern void CRIWARE36366D11();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern void CRIWARE50B51DBE();
...
#else
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern uint CRIWAREE9D3B2B3();
#endif

#if UNITY_EDITOR_WIN || (!UNITY_EDITOR && UNITY_STANDALONE_WIN)
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern void CRIWARE1184E87A(bool enable);
#endif
	...
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern void CRIWARE5B987B97(bool use_h264_playback, UInt32 width, UInt32 height);
#elif !UNITY_EDITOR && UNITY_WEBGL
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern void CRIWARE8ACDA935(string webworkerPath, uint heapSize);
#endif
	#else
	private static bool _dummyInitialized = false;
	private static void CRIWARE28AEBB45(int graphics_api, bool graphics_multi_threaded, int num_decoders, int num_of_max_entries) { }
	private static void CRIWARE7AD1946D() { _dummyInitialized = true; }
	public static bool CRIWARE69680403() { return _dummyInitialized; }
	private static void CRIWAREB4FA43FA() { _dummyInitialized = false; }
	public static void CRIWAREC0B2FB96(bool flag) { }
	public static void CRIWARE36366D11() { }
	public static void CRIWARE50B51DBE() { }
	public static void criMana_UseStreamerManager(bool flag) { }
	public static bool criMana_IsStreamerManagerUsed() { return false; }
#if !UNITY_EDITOR && UNITY_WEBGL
#else
	public static uint CRIWAREE9D3B2B3() { return 0u; }
#endif
#if UNITY_EDITOR_WIN || (!UNITY_EDITOR && UNITY_STANDALONE_WIN)
	public static void CRIWARE1184E87A(bool enable) { }
#endif
#if !UNITY_EDITOR && UNITY_ANDROID
...
#endif
#elif !UNITY_EDITOR && UNITY_PSP2
	public static void CRIWARE5B987B97(bool use_h264_playback, UInt32 width, UInt32 height) { }
#elif !UNITY_EDITOR && UNITY_WEBGL
	public static void CRIWARE8ACDA935(string webworkerPath, uint heapSize) { }
#endif
	#endif
	#endregion
}
