...
public class CriManaMovieMaterial : CriMonoBehaviour
{
	 ...
	 * <remarks>
	 * <para header='Description'>Sets whether to play at Start. The default is False.</para>
	 * </remarks>
	 */
	 ...
	 * <remarks>
	 * <para header='Description'>Loop setting for movie playback at Start. The default is False.</para>
	 ...
	 * <remarks>
	 * <para header='Description'>If True, the playback starts from the beginning when the component is disabled during playback and then enabled.<br/>
	 ...
	 * <remarks>
	 * <para header='Description'>By enabling the Advanced Audio mode, advanced sound playback function can be used. The default is False.<br/>
	 * For example, when playing a movie with Ambisonic sound, this mode must be enabled.</para>
	 * </remarks>
	 */
	 ...
	 * <remarks>
	 * <para header='Description'>Additive synthesis mode setting at Start. The default is False.</para>
	 ...
	 * <remarks>
	 * <para header='Description'>Sets whether to make the movie transparent depending on the transparency of the attached object.<br/>
	 * The default is False.</para>
	 * </remarks>
	 */
	 ...
	 * When playback starts, the status ( ::CriMana::Player::Status ) changes to Playing.</para>
	 ...
	 * Calling the CriManaMovieMaterial::Stop function unpauses the playback</para>
	 * </remarks>
	 */
	...
	public void PlayerManualInitialize()
	{
		...
		if (string.IsNullOrEmpty(moviePath)) {
			...
			maxPathLen = (uint)(moviePath.Length + (CriWare.Common.IsStreamingAssetsPath(moviePath) ? CriWare.Common.streamingAssetsPath.Length + 1 : 0)) + 1;
		}
		player = new CriMana.Player(_advancedAudio, _ambisonics, maxPathLen);
		player.SetMasterTimerType(timerType);
